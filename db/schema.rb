...
ActiveRecord::Schema.define(version: 2020_04_14_072854) do
  ...
  create_table "tenants_users", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
